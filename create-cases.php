...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO `cases`(`id`, `amount`, `platform`, `status`, `name`) VALUES ('$id','$amount','$platform','$status','$name')";
...
<body>
  ...
  <div class="container pt-5 d-flex justify-content-center">
    ...
    <h5 class="text-center monthead">Create A New Case</h2>
    ...
    <td> <label for="id">Name:</label></td>
     <td>   <input type="text" name="name" class="form-control" required><br> </td>
     </tr>
     <tr class="success">
...
$sql = "SELECT id, amount, platform, status, name FROM cases";
...
<div class="d-flex justify-content-center">
<a href="update-cases.php"> <button class="w3-btn bg-primary w3-round-xxlarge w3-padding-large" style="color:white;">Update Case Information</button></a>
    </div>
    </div>
